...
<template>
    ...
    <div class="hero-wrapper text-center px-4 lg:px-10 max-w-[1080px] mx-auto py-16">
        <div class="rotate-25 bg-gradient-to-r from-sky-600/95 to-teal-600/95 w-1/3 h-[120px] filter blur-[160px] absolute mix-blend-screen -z-10 top-16 left-1/3 animate-pulse-slow">
        </div>
        <h1
